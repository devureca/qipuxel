...
export default function WhatsAppButton({ config, visible = true }: WhatsAppButtonProps) {
    const [show, setShow] = useState(false)

    // Aparece después de 1 segundo para no ser invasivo
    useEffect(() => {
    ...
    const message = encodeURIComponent('Hola! Vi tu catálogo y me gustaría consultar.')
    ...
    return (
        ...
        >
            {/* Tooltip */}
            <span
                className="font-sans text-xs font-medium text-white px-3 py-2 rounded-lg whitespace-nowrap shadow-lg"
